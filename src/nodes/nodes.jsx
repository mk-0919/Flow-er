export const initialNodes  = [
  ...
  { 
    id: '2', 
    type: 'function', 
    data: { label: 'count=0を宣言', operationType: "declare", variableName: "count", value: "0" }, 
    position: { x: 50, y: 150 } 
  },
  ...
  { 
    id: '4', 
    type: 'function', 
    data: { label: 'count = count + 1', operationType: "arithmetic", target: "count", operator: "+", operand1: "count", operand2: "1"}, 
    position: { x: 50, y: 350 }, 
  },
  ...
  { 
    id: '6', 
    type: 'function', 
    data: { label: 'countを出力', operationType: "output", variableName: "count"}, 
    position: { x: 50, y: 550 } 
  },
  { 
    id: '7', 
